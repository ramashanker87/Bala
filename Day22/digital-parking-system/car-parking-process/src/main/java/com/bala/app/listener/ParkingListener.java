...
public class ParkingListener {
   ...
   private ParkingEndRepository parkingEndRepository;
    ...
    public String receiveParkingStart(Map<String, Object> message) {
        try {
...
//        if (start == null) {
//            // Handle the case where the parking start record doesn't exist
//            System.out.println("No parking session found for parking number: " + parkingNo);
//            // Optionally, throw an exception or return early if needed
//            return;
//        }
    ...
    return responseMessage;
            ...
            logger.error("Error on Processing parking start",e);
        }
